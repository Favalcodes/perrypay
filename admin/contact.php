...
<body>
    <div class='sidebar'>
        ...
        <ul class="maxsid">
            ...
            <li class="chosen"><i class="fa fa-envelope"></i><a href="contact.php" class="nav-link"> Messages</a></li>
            ...
            <div class="mainC">
                <div class="transaction-body">
                    ...
                    <table class="table table-responsive table-striped">
                        ...
                        <?php
                        while ($tablerow = mysqli_fetch_array($cont)) {
                        ?>
                            <tbody>
                                <tr>
                                    <td scope="row"><?php echo $tablerow['email'] ?></td>
                                    <td><?php echo $tablerow['fullname'] ?></td>
                                    <td><?php echo $tablerow['subject'] ?></td>
                                    <td><?php echo $tablerow['message'] ?></td>
                                </tr>
                            </tbody>
                        <?php } ?>
