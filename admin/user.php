...
<body>
    <div class='sidebar'>
        ...
        <ul class="maxsid">
            ...
            <li class="chosen"><i class="fa fa-user"></i><a href="user.php" class="nav-link"> Users</a></li>
                ...
                <div class="transaction-body">
                    ...
                    <table class="table table-responsive table-striped">
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    <td scope="row"><?php echo $tablerow['firstname'] ?></td>
                                    <td><?php echo $tablerow['lastname'] ?></td>
                                    <td><?php echo $tablerow['username'] ?></td>
                                    <td><?php echo $tablerow['email'] ?></td>
                                    <td><img src="../dashboard/uploads/<?php echo $tablerow['image'] ?>" width="100px" height="100px" /></td>
                                </tr>
                            </tbody>
                        <?php } ?>
