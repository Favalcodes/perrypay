...
$em = $_SESSION['email'];
$tran = "SELECT * FROM transactions ORDER BY id DESC";
...
<body>
    <div class='sidebar'>
        ...
        <ul class="maxsid">
            <li class="chosen"><i class="fa fa-home"></i><a href="home.php" class="nav-link"> Transactions</a></li>
